import type { Finding, ReviewSummary, RiskLevel } from "./types.js";
...
export function renderMarkdown(summary: ReviewSummary): string {
...
export function renderConsole(summary: ReviewSummary): string {
  const lines = [
